...
public class SPP2OVirgenMA08 {
    ...
    public static void main(String[] args) {
       /*
       Este programa promedia el contenido de las posiciones pares y suma 
       el contenido de las posiciones nones de un arreglo
       */
       int promedio;
       int sumaPar=0;
       int sumaNon=0;
